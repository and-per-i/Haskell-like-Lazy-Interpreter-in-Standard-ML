...
Spiega brevemente come è organizzato il codice, citando i file specifici menzionati nel documento:
...
Inserisci un esempio basato su quelli descritti nel documento (sezione 4.3) per mostrare che la sintassi è familiare:
...
Questa sezione dimostra la tua competenza. Puoi spiegare brevemente come hai implementato i Thunk:
...
Essere onesti sulle limitazioni mostra professionalità (basato sulla sezione 5 del PDF):
